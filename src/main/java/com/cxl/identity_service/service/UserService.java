...
public class UserService {
    ...
    public List<UserResponse> getUsers(){
        ...
        return
                userRespository.findAll().stream().map(userMapper::toUserResponse).toList();
    }
    ...
    public UserResponse getMyInfor(){
       ...
       String name= context.getAuthentication().getName();
        User user=userRespository.findByUserName(name).orElseThrow(()->new AppException(ErrorCode.USER_NOT_EXISTED));
